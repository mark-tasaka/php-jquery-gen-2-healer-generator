...
<html>
<head>
<title>Launch Page: MCC Healer Character Generator</title>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="Healer Character Generator" class="image" /></h1>
		...
		<form action="" id ="healerForm2"  target="_blank" method="post">
        ...
        $("#generate_characters2").click(function(){
            ...
            $("#healerForm2").attr('action', "character2/mcc_healer_"+ $("#level").val() + $("#abilityScores").val() +  ".php");
        });
